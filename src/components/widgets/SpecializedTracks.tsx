  ...
  return (
    <section className="z-[-10]">
      <Wrapper>
        ...
        <div className="flex flex-col gap-14 z-[-10] md:flex-row">
          {/* First Section */}
          <div className="flex flex-col mt-6 border-2 border-grey rounded-2xl border-[#00616C] w-full self-start z-[-10] md:sticky md:top-28 md:w-[60%]">
          ...
          <div className="flex flex-col flex-1 gap-4 gap-x-2 gap-y-4 overflow-hidden">
            {Data.map((item, i) => (
              <div key={i} onClick={() => setSelectedItem(item.slug)} className="hover:shadow-xl cursor-pointer">
